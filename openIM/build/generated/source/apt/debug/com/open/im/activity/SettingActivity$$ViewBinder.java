...
public class SettingActivity$$ViewBinder<T extends SettingActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131361858, "method 'onClick'");
    ...
    view = finder.findRequiredView(source, 2131361860, "method 'onClick'");
    unbinder.view2131361860 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onClick(p0);
    ...
    view = finder.findRequiredView(source, 2131361862, "method 'onClick'");
    unbinder.view2131361862 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onClick(p0);
